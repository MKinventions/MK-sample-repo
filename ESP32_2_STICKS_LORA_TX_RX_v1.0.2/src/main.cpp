...
pinMode(switch2, INPUT_PULLUP);
  ...
  { 
    ...
    if(controlMode_value == 0){
      joy1_level = potentiometer_controller(joy1_value, joy1Dir_value, joystick1);
      joy4_level = potentiometer_controller(joy4_value, joy4Dir_value, joystick2);
      joy3_level = potentiometer_controller(joy3_value, joy3Dir_value, joystick3);
      joy2_level = potentiometer_controller(joy2_value, joy2Dir_value, joystick4);
    }
    else if(controlMode_value == 1){
      joy3_level = potentiometer_controller(joy3_value, joy3Dir_value, joystick1);
      joy2_level = potentiometer_controller(joy2_value, joy2Dir_value, joystick2);
      joy1_level = potentiometer_controller(joy1_value, joy1Dir_value, joystick3);
      joy4_level = potentiometer_controller(joy4_value, joy4Dir_value, joystick4);
    }
