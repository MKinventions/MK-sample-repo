...
uint16_t joystick_controller(int joyGpio, int joyValue, int joyDirection, int calibrateValue, int offset) {
  int joystickFinal;
  int joyLevel;
  ...
  if (joystickFinalCopy > midPointValue+offset  || joystickFinalCopy < midPointValue-offset) {
